[Skip Navigation](https://developer.apple.com/documentation/xcode/configuring-your-app-icon#app-main)
...
## [Overview](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#Overview)
...
### [Create an app icon](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#Create-an-app-icon)
...
### [Specify app icon variations](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#Specify-app-icon-variations)
...
### [Add dark and tinted icon variants to iOS and iPadOS](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#Add-dark-and-tinted-icon-variants-to-iOS-and-iPadOS)
...
### [Configure the layers of an image stack](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#Configure-the-layers-of-an-image-stack)
...
Add images to each layer by dragging them from the Finder into the image wells in the detail area of the Asset Catalog in Xcode. For information on the use of layers, see App icons [visionOS](https://developer.apple.com/design/Human-Interface-Guidelines/app-icons#visionOS) and [tvOS](https://developer.apple.com/design/Human-Interface-Guidelines/app-icons#tvOS).

### [Specify an App Store icon](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#Specify-an-App-Store-icon)
...
### [Change the default app icon set](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#Change-the-default-app-icon-set)
...
## [See Also](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#see-also)

### [App icons and launch screen](https://developer.apple.com/documentation/xcode/configuring-your-app-icon\#App-icons-and-launch-screen)
...
Current page is Configuring your app icon using an asset catalog