[Skip Navigation](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer#app-main)
...
## [Overview](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Overview)
...
- For converting older app icons to use the Liquid Glass material, see [Adopting Liquid Glass > App icons](https://developer.apple.com/documentation/TechnologyOverviews/adopting-liquid-glass#App-icons).
...
### [Prepare your artwork for export](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Prepare-your-artwork-for-export)
...
### [Create your Icon Composer file](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Create-your-Icon-Composer-file)
...
### [Import your graphic files](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Import-your-graphic-files)
...
### [Organize layers into groups](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Organize-layers-into-groups)
...
### [Customize the Icon Composer interface](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Customize-the-Icon-Composer-interface)
...
### [Preview variants of your app icon](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Preview-variants-of-your-app-icon)
...
### [Simulate device backgrounds and lighting](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Simulate-device-backgrounds-and-lighting)
...
### [Apply effects to the background, groups, and layers](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Apply-effects-to-the-background-groups-and-layers)
...
### [Apply a gradient fill and opacity](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Apply-a-gradient-fill-and-opacity)
...
### [Apply Liquid Glass effects to groups and layers](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Apply-Liquid-Glass-effects-to-groups-and-layers)
...
### [Change the position and scale of graphics](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Change-the-position-and-scale-of-graphics)
...
[Play](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer#)
...
### [Customize variants of your app icon](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Customize-variants-of-your-app-icon)
...
### [Add your Icon Composer file to an Xcode project](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Add-your-Icon-Composer-file-to-an-Xcode-project)
...
### [Test your app icon on simulated and real devices](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#Test-your-app-icon-on-simulated-and-real-devices)
...
For more information on running your app in Xcode, see [Running your app in Simulator or on a device](https://developer.apple.com/documentation/xcode/running-your-app-in-simulator-or-on-a-device).

## [See Also](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#see-also)

### [App icons and launch screen](https://developer.apple.com/documentation/Xcode/creating-your-app-icon-using-icon-composer\#App-icons-and-launch-screen)
...
Current page is Creating your app icon using Icon Composer